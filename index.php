...
$sql = "SELECT p.*, c.name AS cname FROM posts p, categories c WHERE c.id = p.category_id AND p.status = '0' ORDER BY p.id DESC";
          ...
          <div class="col-lg-4 col-md-12 mb-4">
            <div class="card">
              <div class="bg-image hover-overlay" data-mdb-ripple-init data-mdb-ripple-color="light">
                <img src="<?=$img?>" style ="height: 200px; width: 400px;" class="img-fluid" />
                <a href="#!">
